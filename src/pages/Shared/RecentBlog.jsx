...
const RecentBlog = ({ blogCards}) => {
  ...
  <div className="card-body">
    ...
    <span className="relative">Details</span>
      ...
      <button onClick={() =>handleAddToWishlist(blogCard)} className="relative inline-flex items-center justify-start px-10 py-3 overflow-hidden font-medium transition-all bg-red-500 rounded-xl group">
